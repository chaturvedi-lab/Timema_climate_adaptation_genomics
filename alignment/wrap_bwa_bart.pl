...
my $walltime = '50:00:00'; ## Format: hh:mm:ss
...
my $ppn = '10'; # Number of tasks per node
...
my $dir = '/uufs/chpc.utah.edu/common/home/u6007910/projects/timema_adaptation/alignments/fastqfiles/bart';
my @jobarray;
my $aln;
#my $samse;
my $ind;
my $genome = "/uufs/chpc.utah.edu/common/home/u6007910/projects/timema_adaptation/consensus_align/references/filtered2x_variantsTimemaBart.vcf.gz.fasta";
my $cd = "cd $dir\n";
